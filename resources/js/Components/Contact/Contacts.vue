<template>
  <div class="frame-container min-h-[100vh]">
      <div class="flex justify-between px-4 mb-4">
          <div>
              <p class="font-semibold font-inter text-black mb-3">Contacts</p>
          </div>
          <div>
              <button
                  @click="
                                  ...
                                  >
                                      <button
                                          ...
                                          @click="
                                              ...
                                              edit_contact.name = contact.name;
                                              edit_contact.phone_number = contact.phone_number;
                                          "
                                      >
          ...
          >
              ...
              >
                  <h5
                      ...
                      id="ModalLabel"
                  >
                      {{ edit_contact.id ? "Edit contact" : "Add contact" }}
                  </h5>
                  <button
                      type="button"
                      id="closeModal"
...
methods: {
    ...
    async updateOrCreateContact() {
        if (!this.edit_contact.name || !this.edit_contact.phone_number) {
            return;
        }
        let formData = new FormData();
        if (this.edit_contact.id) {
            formData.append("id", this.edit_contact.id);
        }
        formData.append("name", this.edit_contact.name);
