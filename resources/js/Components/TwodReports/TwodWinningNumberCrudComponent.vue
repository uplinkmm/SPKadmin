        ...
        >
            ...
            >
                ...
                <div class="relative flex-auto p-4" data-twe-modal-body-ref>
                    <div class="mb-6">
                        <label for="2d" class="text-sm mb-3 relative block"
                            >2d</label
                        >
                        <input
                            type="text"
            ...
            >
                ...
                <div class="relative flex-auto p-4" data-twe-modal-body-ref>
                    <div class="relative pb-6">
                        <label for="edit_2d" class="text-sm mb-3 relative block"
                            >2D Number</label
                        >
                        <input
                            type="number"
                        ...
                        />
                        <span
                            class="text-xs text-red-600 absolute bottom-0"
                            v-if="isEditNumber"
                            >Please Add 2D Number</span
                        >
                    </div>
                </div>
                <div
...
export default {
    ...
    methods: {
        ...
        async getNumberList(reset_page) {
            ...
            let url = `/api/2d/betting_wins?from_date=${
                this.fromDate
            ...
            if (response.data) {
                ...
                this.setTotalCount(
                    response.data.last_page * response.data.per_page
                );
            }
        },
