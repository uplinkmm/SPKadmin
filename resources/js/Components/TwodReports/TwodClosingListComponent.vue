                    ...
                    >
                        ...
                        >
                            <label
                                ...
                                "
                                class="flex items-center justify-center gap-x-0.5 sm:gap-x-1 rounded-md px-0.5 py-1 text-sm sm:text-md lg:text-base"
                            >
                                <input
                                    :id="
                                        'check-' +
                            ...
                            <p
                                class="pl-1 sm:pl-2 text-[13px] sm:text-md lg:text-base"
